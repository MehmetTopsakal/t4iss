...
def make_333_supercell(labels, natoms, lattice, positions):
    ...
    positions_supercell = positions_supercell.\
                          reshape(len(p)*27, 3, order='F').copy()
    ...
    return labels_supercell, natoms_supercell, \
           lattice_supercell, positions_supercell
...
def feff_write_inp(structure, dmax=10.1, rFMS=8.1, rSCF=6.1, corehole='RPA',
    ...
    labels_supercell, natoms_supercell, \
    lattice_supercell, positions_supercell \
    ...
    if len(positions_shifted) < 50:
        labels_supercell, natoms_supercell, \
        lattice_supercell, positions_supercell \
            = make_333_supercell(labels_supercell, natoms_supercell,
                                 lattice_supercell, positions_supercell)
